...
// Memory is zeroed on the server side when allocated; this stub satisfies the
// local ggml assertion that memset_tensor must be implemented.
static void ggml_backend_rpc_buffer_memset_tensor(ggml_backend_buffer_t buffer, ggml_tensor * tensor,
